{lib, ...}: {
  ...
  home.file = 
    let folders = {
      ...
      "com.system76.CosmicBackground" = ../../config/cosmic/com.system76.CosmicBackground;
      ...
      "com.system76.CosmicSettings.Wallpaper" = ../../config/cosmic/com.system76.CosmicSettings.Wallpaper;
